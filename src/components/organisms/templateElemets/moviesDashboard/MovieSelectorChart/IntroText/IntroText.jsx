...
export default function IntroText() {
  ...
  return (
    <>
      <>
        <TextContainer>
          Hi there, thank you so much for passing by! Please let me welcome you
          on your first visit of this dashboard!
        </TextContainer>
        <TextContainer>
          To quickly explain the idea behind it, allow me to ask you a question:
          have you ever wanted to more easily explore discover more about the
          filmography of some of your favorite actors, directors or
        ...
        <TextContainer>
          ...
          see this middle part getting populated and you can start exploring the
          data by hovering over the elements and by just clicking around!
        </TextContainer>
        <TextContainer>
        ...
        <TextContainer>
          ...
          receiving some cool new features and getting some issues fixed. If you
          feel like share an idea about what type of features you would like to
          be added or any feedback about potential issues, please feel free to
          contact me anytime via{" "}
          <span style={{ position: "relative" }}>
            <LnkContainer
              initial={{ width: 60 }}
              animate={{ width: isLinkHovered ? 115 : 60 }}
            >
              <Link
